...
function(a, b) {
	...
	C = {
		...
		onMenuShareAppMessage: function(a) {
			api_on(o.onMenuShareAppMessage, {
				complete: function() {
		...
		startRecord: function(a) {
			invoke("startRecord", {}, a)
		},
		stopRecord: function(a) {
			invoke("stopRecord", {}, a)
		},
		onVoiceRecordEnd: function(a) {
			api_on("onVoiceRecordEnd", a)
		},
		...
		showOptionMenu: function(a) {
			invoke("showOptionMenu", {}, a)
		},
		closeWindow: function(a) {
			a = a || {}, invoke("closeWindow", {
		...
		hideAllNonBaseMenuItem: function(a) {
			invoke("hideAllNonBaseMenuItem", {}, a)
		},
		showAllNonBaseMenuItem: function(a) {
			invoke("showAllNonBaseMenuItem", {}, a)
		},
		scanQRCode: function(a) {
			a = a || {}, invoke("scanQRCode", {
		...
		openProductSpecificView: function(a) {
			invoke(o.openProductSpecificView, {
				pid: a.productId,
